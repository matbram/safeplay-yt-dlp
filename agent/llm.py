...
=============================
The system is currently configured for AUDIO-ONLY downloads using:
  "worstaudio[protocol=https]/worstaudio/bestaudio[ext=m4a]/bestaudio"

Current behavior:
- Downloads the lowest bitrate audio format (optimized for speed)
- Output is typically m4a or webm audio
- Focus your analysis on audio stream issues
...
5. Focus on fixes relevant to the current audio-only configuration
...
- Downloads the lowest bitrate audio format (optimized for speed)
- Output is typically m4a or webm audio
- Focus your analysis on patterns relevant to the current configuration
...
5. Focus on learnings relevant to the current system configuration
...
- Downloads the lowest bitrate audio format (optimized for speed)
- Output is typically m4a or webm audio
- Focus your optimizations on the current audio configuration
